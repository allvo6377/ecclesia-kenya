...
echo   4) Branch: main   Folder: / (root)   then Save
echo   5) Wait ~1 minute, then your live URL appears at the top of that page:
echo        https://YOURNAME.github.io/ecclesia-kenya/
echo ---------------------------------------------------
echo.
pause
