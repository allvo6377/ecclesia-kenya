...
function Topbar({
  ...
  }), " Admin · on")), /*#__PURE__*/React.createElement("div", {
...
function App() {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "f-note"
  }, "A directory of the Catholic Church in Kenya — cathedrals and parishes across every archdiocese and diocese, with Mass times, contacts and locations. Please confirm service times with the parish office before visiting."), authed && /*#__PURE__*/React.createElement("a", {
    className: "f-admin",
