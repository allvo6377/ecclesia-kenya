  ...
  return (
    <div className="dio-page">
      <div className="dir-hero">
        <div className="eyebrow">Ecclesiastical map · Kenya</div>
        <h1 className="serif">Browse by diocese.</h1>
        <p>The Catholic Church in Kenya is organised into archdioceses and dioceses, each led by a bishop
          from its cathedral. Explore the parishes within each jurisdiction below.</p>
      </div>
