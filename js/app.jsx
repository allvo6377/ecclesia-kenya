        ...
        <nav className="nav-links">
          ...
          {authed && (
            <a className={is("admin") + " nav-admin"} onClick={() => onNav("admin")}>
              <window.I.lock style={{ width: 14, height: 14 }} /> Admin · on
            </a>
          )}
        </nav>
    ...
    <div className="app">
      ...
      <footer className="foot">
        <div className="foot-inner">
          ...
          {authed && <a className="f-admin" onClick={() => navigate("admin")}><window.I.gear style={{ width: 14, height: 14 }} /> Parish administration</a>}
        </div>
      </footer>
