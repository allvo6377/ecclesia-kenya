  ...
  return (
    <div>
      <div className="dir-hero">
        {mapMode ?
        <React.Fragment>
            <div className="eyebrow">Interactive Map · Kenya</div>
            <h1 className="serif">Explore parishes on the map.</h1>
            <p>Every parish in the directory, plotted across Kenya. Click a pin for details and Mass times, or filter the set below  the map updates as you search.
          </p>
          </React.Fragment> :

        <React.Fragment>
            <div className="eyebrow" style={{ padding: "0px 0px 5px" }}>Catholic Directory · Kenya</div>
            <h1 className="serif" style={{ padding: "50px 0px 0px" }}>Find a Catholic parish anywhere in Kenya.</h1>
            <p>Browse cathedrals, basilicas and parishes across the dioceses of Kenya  with Mass times, contacts and locations on the map. Search by name, filter by diocese or language, or find the parish nearest you.
          </p>
          </React.Fragment>
        }
      </div>
      ...
      <div className={"dir-body " + layout}>
        <div className="list-col">
          ...
          <p className="muted" style={{ fontSize: 12.5, marginTop: 14 }}>Tip: hover a parish to locate it on the map · click a card or a map pin’s “View parish” to open its page.</p>
        </div>
