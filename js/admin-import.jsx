        ...
        <div className="modal-body">
          ...
          {stage === "done" && (
            <div className="import-done">
              ...
              <p className="muted">They're now live across the directory, map and dioceses views. Parishes missing coordinates won't appear on the map until you add them.</p>
            </div>
          )}
        </div>
